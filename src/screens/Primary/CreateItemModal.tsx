...
import { CREATE_PRIMARY_STORE } from "../../config/apiUrl";
...
const CreateItemModal: React.FC<CreateItemModalProps> = ({
  ...
  const createItem = async (data: ItemData) => {
    ...
    const response = await axios.post(CREATE_PRIMARY_STORE, data, {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["primaryItems", page] });
